...
def split_trajectories(split_root: Path) -> list[str]:
    for filename in ("rollout_traj_names.txt", "traj_names.txt"):
...
def candidate_windows(
    ...
    result = []
    for trajectory in sorted(split_trajectories(split_root)):
